// ARM NEON int8 kernel implementations for gemma4.c.
...
//
// The int4 matmul lives in kernels_neon_int4.c.

#if !defined(__aarch64__)
#error "kernels_neon_int8.c requires an aarch64 target. Use kernels_pure_int8.c for other architectures."
#endif
...
// matmul_int4 lives in kernels_neon_int4.c.
